...
#define ELAPSE_800ms    (1u * 800          	/ USER_TICK_PERIOD)

#define ELAPSE_1100ms   (1u * 1100          / USER_TICK_PERIOD)
#define ELAPSE_1500ms   (1u * 1500          / USER_TICK_PERIOD)
#define ELAPSE_2500ms   (1u * 2500          / USER_TICK_PERIOD)
//
...
#define ELAPSE_4s       (1000u * 3         	/ USER_TICK_PERIOD)
#define ELAPSE_5s       (1000u * 5         	/ USER_TICK_PERIOD)
#define ELAPSE_6s       (1000u * 6         	/ USER_TICK_PERIOD)
#define ELAPSE_8s       (1000u * 8         	/ USER_TICK_PERIOD)
#define ELAPSE_9s       (1000u * 9         	/ USER_TICK_PERIOD)
...
#define ELAPSE_40s      (1000u * 40		    	/ USER_TICK_PERIOD)
#define ELAPSE_50s      (1000u * 50		    	/ USER_TICK_PERIOD)
#define ELAPSE_70s      (1000u * 70		    	/ USER_TICK_PERIOD)
#define ELAPSE_90s      (1000u * 90		    	/ USER_TICK_PERIOD)
#define ELAPSE_150s     (1000u * 150		    / USER_TICK_PERIOD)
// 
#define ELAPSE_1min     (1000u * 60 * 1    	/ USER_TICK_PERIOD)
#define ELAPSE_2min     (1000u * 60 * 2    	/ USER_TICK_PERIOD)
#define ELAPSE_3min     (1000u * 60 * 3    	/ USER_TICK_PERIOD)
#define ELAPSE_5min     (1000u * 60 * 5    	/ USER_TICK_PERIOD)
#define ELAPSE_6min     (1000u * 60 * 6    	/ USER_TICK_PERIOD)
#define ELAPSE_7min     (1000u * 60 * 7    	/ USER_TICK_PERIOD)
#define ELAPSE_10min    (1000u * 60 * 10   	/ USER_TICK_PERIOD)
#define ELAPSE_20min    (1000u * 60 * 20   	/ USER_TICK_PERIOD)
#define ELAPSE_30min    (1000u * 60 * 30	  / USER_TICK_PERIOD)
//
#define ELAPSE_1h       (1000u * 60 * 60 * 1    / USER_TICK_PERIOD)
#define ELAPSE_2h       (1000u * 60 * 60 * 2    / USER_TICK_PERIOD)
#define ELAPSE_3h       (1000u * 60 * 60 * 3    / USER_TICK_PERIOD)
#define ELAPSE_5h       (1000u * 60 * 60 * 5    / USER_TICK_PERIOD)
#define ELAPSE_3d       (1000u * 60 * 60 * 24*3    / USER_TICK_PERIOD)
